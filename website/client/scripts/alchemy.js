...
Modernizr.load({
    ...
    nope: 'frameworks/web-socket-js/web_socket.js'
});


WEB_SOCKET_SWF_LOCATION = 'frameworks/web-socket-js/WebSocketMain.swf';
...
(function() {
  ...
  Alchemy.prototype = {
    ...
    Start: function() {
      var server = 'ws://' + this._options.Server + ':' + this._options.Port + "/jabbo";
      var ACInstance = this;
