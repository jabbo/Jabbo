...
jQuery(document).ready(function($) {
  $('<div></div>').html(CHROMFRAME_OPTIONS.message || 'Internet Explorer mist software om deze webpagina weer te kunnen geven. Klik hier om te updaten.')
  .activebar(window.CHROMFRAME_OPTIONS);
});*/
